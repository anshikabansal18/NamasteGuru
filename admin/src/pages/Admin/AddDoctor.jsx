...
const AddDoctor = () => {
    ...
    const [speciality, setSpeciality] = useState('PERSONAL DEVELOPMENT')
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Technology_Expert">TECHNOLOGY_EXPERT</option>
                                <option value="Finance Advisor">Finance Advisor</option>
                                <option value="STARTUP_MENTOR">STARTUP MENTOR</option>
                            </select>
                        </div>
